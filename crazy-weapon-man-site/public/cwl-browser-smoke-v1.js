(()=>{
  ...
  const BUILD='cwl-browser-smoke-v1-20260915a';
    ...
    try{
      ...
      setTimeout(()=>{
        try{
          ...
          report.ok=combat&&hudVisible&&oldHidden&&mixed;report.wave0=wave0;report.wave1=wave1;report.combat=combat;report.hudVisible=hudVisible;report.oldHudHidden=oldHidden;report.enemyCount=(second.enemies||[]).length;report.at=Date.now();
